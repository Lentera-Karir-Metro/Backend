-- =====================================================
-- ADDITIONAL COURSES DATA (FIXED - No description in Modules)
-- =====================================================
...
-- =====================================================
-- MODULES DATA (FIXED - Removed description column)
-- =====================================================

-- CR-000034: Deployment & DevOps Fundamentals
...
('MD-000029', 'CR-000034', 'Deployment Strategies', 'ebook', 3, NULL, 30, NOW(), NOW()),
('MD-000030', 'CR-000034', 'Deployment Quiz', 'quiz', 4, NULL, 20, NOW(), NOW());

-- CR-000035: Web Security Best Practices
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000036: Testing & Quality Assurance
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000037: Advanced Prototyping Techniques
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000038: Accessibility Design (A11y)
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000039: Motion Design for UI
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000040: Deep Learning Fundamentals
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000041: Natural Language Processing
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000042: Big Data Technologies
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000044: Influencer Marketing Strategy
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000045: Email Marketing Automation
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000046: Advanced Flutter Animations
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000047: Flutter Performance Optimization
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000048: Publishing to App Stores
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000049: Advanced Penetration Testing
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000050: Security Operations Center (SOC)
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000052: AWS Lambda & Serverless
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000053: AWS Security & Compliance
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000054: AWS Cost Optimization
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000055: Growth Product Management
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000056: Product Analytics & Metrics
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000057: Stakeholder Management
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000059: NFT Marketplace Development
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000060: Web3 Security & Auditing
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000061: Advanced Color Grading
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000062: YouTube Algorithm & SEO
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
-- CR-000063: Monetization Strategies
INSERT INTO Modules (id, course_id, title, module_type, sequence_order, durasi_video_menit, estimasi_waktu_menit, createdAt, updatedAt) VALUES
...
INSERT INTO Certificates (id, user_id, learning_path_id, issued_at, total_hours, certificate_url, createdAt, updatedAt) VALUES
('CERT-000005', 'LT-768548', 'LP-000002', '2025-11-20', 18, 'https://certificates.lenterakarir.com/cert-000005.pdf', NOW(), NOW()),
('CERT-000006', 'LT-768548', 'LP-000005', '2025-11-25', 22, 'https://certificates.lenterakarir.com/cert-000006.pdf', NOW(), NOW()),
('CERT-000007', 'LT-130230', 'LP-000003', '2025-11-18', 25, 'https://certificates.lenterakarir.com/cert-000007.pdf', NOW(), NOW()),
('CERT-000008', 'LT-130230', 'LP-000007', '2025-11-22', 20, 'https://certificates.lenterakarir.com/cert-000008.pdf', NOW(), NOW()),
('CERT-000009', 'LT-130230', 'LP-000009', '2025-11-28', 28, 'https://certificates.lenterakarir.com/cert-000009.pdf', NOW(), NOW()),
('CERT-000010', 'LT-912152', 'LP-000004', '2025-11-15', 16, 'https://certificates.lenterakarir.com/cert-000010.pdf', NOW(), NOW()),
('CERT-000011', 'LT-912152', 'LP-000006', '2025-11-19', 24, 'https://certificates.lenterakarir.com/cert-000011.pdf', NOW(), NOW()),
('CERT-000012', 'LT-912152', 'LP-000008', '2025-11-26', 19, 'https://certificates.lenterakarir.com/cert-000012.pdf', NOW(), NOW()),
('CERT-000013', 'LT-912152', 'LP-000010', '2025-11-30', 21, 'https://certificates.lenterakarir.com/cert-000013.pdf', NOW(), NOW());

-- =====================================================
-- SUMMARY
-- =====================================================
-- ✅ 30 Courses Added (CR-000034 to CR-000063)
-- ✅ 120 Modules Added (MD-000027 to MD-000146)
-- ✅ 9 Certificates Added (CERT-000005 to CERT-000013)
-- ✅ FIXED: Removed 'description' column from Modules INSERT
-- ✅ FIXED: Changed 'issued_date' to 'issued_at' and added 'total_hours' in Certificates INSERT
-- =====================================================
